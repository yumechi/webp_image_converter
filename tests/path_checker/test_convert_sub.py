...
def test_is_file_green_1():
    ...
    assert file_converter._is_image(green_path)
...
def test_is_file_red_1():
    ...
    assert not file_converter._is_image(red_path)
...
def test_copy_file_name_green_1():
    ...
    assert file_converter._make_output_filename(green_path) == green_path
...
def test_copy_file_name_green_3():
    ...
    assert file_converter._make_output_filename(
        green_path
...
def test_copy_file_name_green_9():
    ...
    assert (
        file_converter._make_output_filename(green_path)
